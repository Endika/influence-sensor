...
describe('analyze', () => {
  it('assembles a complete report', () => {
    ...
    expect(r.accounts[0]).toEqual({ account: 'big', interactions: 3, share: 0.75, followed: true })
    expect(r.accounts[1]).toEqual({ account: 'small', interactions: 1, share: 0.25, followed: false })

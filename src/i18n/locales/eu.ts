...
export const eu: Record<string, string> = {
  ...
  'kind.title': 'Nola elkarrekin aritzen zaren',
  'kind.caption': 'Zure elkarrekintzen nahasketa motaren arabera.',
  'kind.story_like': 'Istorioei atsegin dut',
  'kind.story_poll': 'Inkestak',
  'kind.story_slider': 'Sliders',
  'kind.story_reaction': 'Istorioei erreakzioak',
  'kind.like_comment': 'Iruzkinei atsegin dut',

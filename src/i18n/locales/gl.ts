...
export const gl: Record<string, string> = {
  ...
  'kind.title': 'Como interactúas',
  'kind.caption': 'A mestura das túas interaccións por tipo.',
  'kind.story_like': 'Gústame a historias',
  'kind.story_poll': 'Enquisas',
  'kind.story_slider': 'Sliders',
  'kind.story_reaction': 'Reaccións a historias',
  'kind.like_comment': 'Gústame a comentarios',
